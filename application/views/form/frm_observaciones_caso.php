<div id="content" class="col-xs-12 col-sm-10">
	...
	<div id="breadcrumb" class="col-md-12">
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url().'crud_caso/responsable'; ?>">Resultados</a></li>
		</ol>
	</div>
	</div>
<div class="row">
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					<i class="fa fa-usd"></i>
					<span>Casos Reportados con Responsable</span>
				</div>
				<div class="box-icons">
				...
				<table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
					...
					<!-- Start: list_row -->
						<?php foreach ($casos as $casos):?>
                                            <tr>
                                            <td><?= $casos->id_caso?></td> 
                                            <td><?= $casos->nombre_caso?></td>
                                            <td><?= $casos->descripcion?></td> 
                                            <td><?= $casos->reporto_caso?></td> 
                                            <td><?= $casos->ubicacion?></td>
                                            <td><?= $casos->Responsable?></td>
                                             <input  type="hidden" name="post" value="1" /> 
                                            <td align="center"><button type="button" onclick=location="<?php echo base_url().'crud_caso/resultado'.$casos->id_caso; ?>" class="btn btn-primary"><i class=""></i>Observaciones</button></td>
                                 </tr>
                                    <?php endforeach ;?>           
					<!-- End: list_row -->
					</tbody>
